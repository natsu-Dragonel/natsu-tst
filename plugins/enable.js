...
*الوصف:* تشغيل وا ايقاف مضاد اي لينكات.
*الحاله:* يجب ان يكون مفعلا.
...
*الوصف:* هيبدا البوت يرد باستخدام الذكاء الاصتناعي سمسمي.
...
*الحاله:* المطور بس الي يستخدم الامر ده.`.trim();
  ...
  conn.sendMessage(m.chat, {text: `🗂️ الخيار: ${type}\n🎚️ ولايه: ${isEnable ? 'شغال' : 'قافل'}\n📣 اين: ${isAll ? 'هذا البوت' : isUser ? '' : 'هذا الدردشه'}`}, {quoted: m});
};
handler.help = ['en', 'dis'].map((v) => v + 'able <option>');
handler.tags = ['group', 'owner'];
handler.command = /^((en|dis)able|(on|off)|(turn)?[01])$/i;
