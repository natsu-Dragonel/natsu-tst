...
if (size.split('MB')[0] >= limit) return conn.reply(m.chat,` الملف اكثر من${limit} ميغابايت، تم إلغاء التنزيل.`, m).then(_ => m.react('✖️'))
...
if (size.split('MB')[0] >= limit) return conn.reply(m.chat,` الملف أكثر من ${limit} ميغابايت، تم إلغاء التنزيل.`,  m, fake,).then(_ => m.react('✖️'))
